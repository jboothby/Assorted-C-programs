...
#define RESIZE_FACTOR 5		// multiple to enlarge table by for each growth
				// default of 3 as stated in assignment
#define MAX_DEPTH 15		// max depth of any linked list in the hash table
